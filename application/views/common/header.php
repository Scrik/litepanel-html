		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="http://<?php echo $_SERVER['SERVER_ADDR'] ?>/phpmyadmin/">ПУ БД</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-credit-card"></span> <?php echo $user_balance ?> руб<b class="caret"></b></a>
						<ul class="dropdown-menu">
						<li><a href="/">Профиль</a></li>
						<li><a href="/account/pay">Пополнить</a></li>
						<li class="divider"></li>
						<li><a href="/account/invoices">История пополнений</a></li>
						</ul>
					</li>
				</ul>
			</div>
    	...
    	<div class="row">
    		<div class="col-md-3">
    			...
    			<div id="userNavMode"<?php if($activesection == "admin"): ?> style="display: none;"<?php endif; ?>>
					...
					<h3>Аккаунт</h3>
					<div class="list-group">
						<a href="/account/pay" class="list-group-item<?php if($activesection == "account" && $activeitem == "pay"): ?> active<?php endif; ?>"><span class="glyphicon glyphicon-usd"></span> Пополнение баланса(RK)</a>
						<a href="/account/unitpay" class="list-group-item<?php if($activesection == "account" && $activeitem == "unitpay"): ?> active<?php endif; ?>"><span class="glyphicon glyphicon-usd"></span> Пополнение баланса(unitpay)</a>
    			...
    			<div id="administratorNavMode"<?php if($activesection != "admin"): ?> style="display: none;"<?php endif; ?>>
					...
					<div class="list-group">
						...
						<a href="/news/create" class="list-group-item<?php if($activesection == "admin" && $activeitem == "news"): ?> active<?php endif; ?>"><span class="glyphicon glyphicon-list"></span> Создать новость</a>
					</div>
					<?php endif; ?> 
