...
<?php echo $header ?>
					...
					<table class="table table-bordered">
						<tr>
							<th width="200px" rowspan="20">
								<div align="Center"><img src="http://cpanel.advens.ru/img/samp.png" style="width:160px; margin-bottom:5px;"></div>
				...
				<div class="panel panel-default">
					...
					<table class="table table-bordered">
						<tbody><tr>
							<td><iframe src="ftp://gs<?php echo $server['server_id'] ?>:<?php echo $server['server_password'] ?>@<?php echo $server['location_ip'] ?>:21" width="835" height="500" style="border: 0px"></iframe></td>
						</tr>
					</tbody></table>
				</div>
